...
const cfg = {
  ...
  whitelistIP: env.get('WHITELIST_IP').default('192.168.5.97').asList(),
  callbackURL: env.get('CALLBACK_URL').default('moov.tg:443').asUrlString(),
  enableTestAPI: env.get('ENABLE_TEST_API').default('false').asBool(),
